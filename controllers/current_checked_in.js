...
router.get('/',(req,res)=>{
  req.getConnection(function(err, connection) {
    ...
    connection.query(`SELECT * FROM checking_system.sign_in_tabel inner join bootcamp_students on  sign_in_tabel.stu_id=bootcamp_students.stu_id where Date(sign_in_date)=Date(NOW());`, function (err, result, fields) {
         if (err) throw err;
